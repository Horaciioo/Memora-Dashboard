...
export const ACADEMY_FIELD_COPY = {
  ...
  summary: 'Description',
  trainers: 'Formateurs',
  trainersHint: 'Des modérateurs, jamais quelqu’un d’extérieur à l’équipe.',
  account: 'Modérateur',
  accountHint: 'Le junior est forcément un compte existant.',
  trainer: 'Formateur référent',
  track: 'Voie',
  juniorStatus: 'Suivi',
  liveCount: 'Lives accompagnés',
  liveCountHint: 'Twitch et YouTube valident autour de treize lives.',
  juniorSummary: 'Remarques',
  kind: 'Type de moment',
  title: 'Intitulé',
  scheduledAt: 'Date et heure',
  junior: 'Junior concerné',
  juniorHint: 'Laisse vide si le moment concerne toute la session.',
  notes: 'Notes',
  heldAt: 'Date du bilan',
  feeling: 'Ressenti global',
  feelingHint: 'On commence toujours par là.',
  ...
  objectivesHint: 'Deux au minimum, formulés concrètement.',
