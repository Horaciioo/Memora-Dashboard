export const Permissions = {
  ...
  MemberPimRead: 'member:pim:read',
  MemberPimWrite: 'member:pim:write',
...
export const PermissionsList: PermissionMeta[] = [
  ...
  {
    name: Permissions.MemberPimRead,
    group: PermissionGroups.Members,
    displayName: 'Lire les PIM',
    description: 'Ouvrir les fiches de PIM déjà tenues.',
    important: true,
  },
  {
    name: Permissions.MemberPimWrite,
    group: PermissionGroups.Members,
    displayName: 'Tenir une PIM',
    description: 'Créer et remplir une fiche de PIM.',
    important: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Valider une formation et faire avancer un junior.',
    important: true,
  },
  {
